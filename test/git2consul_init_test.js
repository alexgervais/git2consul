...
describe('Initializing git2consul', function() {
  ...
  it ('should support disabling include_file_name mode', function(done) {
    ...
    git_commands.init(git_utils.TEST_REMOTE_REPO, function(err) {
      ...
      git_utils.addFileToGitRepo("readme.md", "Test file branch-less KV", "Test commit.", function(err) {
        ...
        repo.init(function(err) {
          if (err) return done(err);
          consul_utils.validateValue('test_repo/master', "Test file branch-less KV", function(err, value) {
            if (err) return done(err);
            done();
          });
        });
  ...
  it ('should support disabling include_branch_name and include_file_name mode', function(done) {
    ...
    git_commands.init(git_utils.TEST_REMOTE_REPO, function(err) {
      ...
      git_utils.addFileToGitRepo("readme.md", "Test file branch-less KV", "Test commit.", function(err) {
        ...
        repo.init(function(err) {
          if (err) return done(err);
          consul_utils.validateValue('test_repo', "Test file branch-less KV", function(err, value) {
            if (err) return done(err);
            done();
          });
        });
